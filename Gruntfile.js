module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		uglify: {
			...
			dev: {
				files: {
					'src/ng-app/ng-<%= pkg.name %>.js': ['src/ng-app/ngStartup.js', 'src/ng-app/**/*.js', '!src/ng-app/**/*.min.js']
				}
			},
			dist: {
				files: {
					'src/ng-app/ng-<%= pkg.name %>.js': ['src/ng-app/ngStartup.js', 'src/ng-app/**/*.js', '!src/ng-app/**/ng-<%= pkg.name %>.js'],
